...
/*
class to access data from the database
 */
...
// to insert reminder content into the database
...
// to delete reminder details from the database
    @Override
...
// to update reminder in the database
