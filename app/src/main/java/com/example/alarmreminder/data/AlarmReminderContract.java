...
public class AlarmReminderContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.example.alarmreminder";// the package used

    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    public static final String PATH_VEHICLE = "reminder-path"; // path for the table
...
// helper method to get column string
